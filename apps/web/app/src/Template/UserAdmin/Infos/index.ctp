...
if ($page_config->parent_config_id)
	$page_config_title = __('{0}<br/><div style="width: 100%; white-space: nowrap;overflow: hidden;text-overflow: ellipsis;"><small>【導入事例】{1}</small></div>', $page_config_title, h($parent_info->title));
?>
